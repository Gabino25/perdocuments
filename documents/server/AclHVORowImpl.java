...
// ---------------------------------------------------------------------
public class AclHVORowImpl extends OAViewRowImpl {
    public static final int CODEK = 0;
    public static final int CODE = 1;
    public static final int MEANING = 2;

    /**This is the default constructor (do not remove)
     */
    public AclHVORowImpl() {
    }

    /**Gets the attribute value for the calculated attribute CodeK
     */
    public String getCodeK() {
        return (String) getAttributeInternal(CODEK);
    }

    /**Sets <code>value</code> as the attribute value for the calculated attribute CodeK
     */
    public void setCodeK(String value) {
        setAttributeInternal(CODEK, value);
    }
